...
- [Quickstart](/tools/tool-name/quickstart): Get started in minutes
- [First guide](/tools/tool-name/guides/first-guide): Learn core concepts
  :::
...
Support information and Discord channel
:::
