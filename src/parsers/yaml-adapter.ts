...
import { YamlTranslationStrategy } from '../core/strategies/yaml';
import { translateText } from '../ai/translate';

export class YamlStrategyAdapter implements TranslationStrategy {
  private coreStrategy: YamlTranslationStrategy;
  
  constructor() {
    this.coreStrategy = new YamlTranslationStrategy({
  ...
  async translate(
    ...
    // Reconstruct the YAML with translations
